    ...
    return LaunchDescription(
        [
            ...
            Node(
                ...
                name="player_1_scripted",
                output="screen",
                parameters=[
                    {
                        "player_name": "ScriptedCpp",
                        "plan_turn_service": "/player_1_scripted/plan_turn",
                    }
                ],
            ),
            TimerAction(
                ...
                actions=[
                    Node(
                        package="ttt_dummy",
                        executable="dummy_player_node",
                        name="player_0_dummy",
                        output="screen",
                        parameters=[
                            {
                                "player_name": "Dummy",
                                "plan_turn_service": "/player_0_dummy/plan_turn",
                            }
                        ],
                    )
                ],
